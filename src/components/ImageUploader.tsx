    ...
    <div className="bg-white dark:bg-zinc-900 p-4 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800">
      <div className="flex flex-col sm:flex-row gap-3 items-center">
        ...
        <form onSubmit={handleUrlSubmit} className="flex-1 w-full flex gap-2">
          ...
          <button
            type="submit"
            className="px-4 py-2.5 bg-zinc-900 hover:bg-zinc-800 dark:bg-zinc-100 dark:hover:bg-zinc-200 text-white dark:text-zinc-900 rounded-xl font-medium transition-colors text-sm"
          >
            确定
          </button>
        </form>
